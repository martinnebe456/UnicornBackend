...
const Errors = require("../api/errors/backend-main-error.js");
...
const logger = LoggerFactory.get("BackendMainAbl");

class BackendMainAbl {
  constructor() {
  ...
  async init(uri, dtoIn, session) {
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "UnicornBackend",
        typeCode: "unicorn-backend-maing01",
        location: location,
...
module.exports = new BackendMainAbl();
